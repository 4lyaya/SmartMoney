...
@section('content')
    <div class="space-y-6">
                            ...
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        ${{ number_format(array_sum($chartData['income']), 2) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        ${{ number_format(array_sum($chartData['expense']), 2) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        ${{ number_format(array_sum($chartData['income']) - array_sum($chartData['expense']), 2) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow transition-all hover:shadow-md min-h-[400px]">
